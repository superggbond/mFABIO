...
#' \describe{
#'   \item{G}{A numeric matrix of predicted gene expression values (2,000 individuals x 300 gene-tissue pairs).
#'             Column names are in format 'Tissue-GeneID'.}
#'   \item{y}{A numeric vector of binary outcomes (0 or 1) for 2,000 individuals.}
#'   \item{X}{A numeric matrix of genotypes (2,000 individuals x 1,000 SNPs).}
#' }
#'
#' @examples
#' data(example_data)
